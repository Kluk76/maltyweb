...
$PAGE_DESCRIPTIONS = [
    ...
    'brewing-lookup'   => 'La <strong>consultation d\'un brassin</strong> en lecture seule. Recherchez par date ou par recette et numéro de lot pour retrouver la fiche complète d\'une session de brassage : en-tête du brassin, densités mesurées (densité à refroidissement, profil temporel) et liste des ingrédients tels qu\'ils ont été saisis. Rien ne s\'y modifie — c\'est l\'outil de référence pour vérifier les paramètres d\'un brassin passé sans parcourir les journaux.',
...
$PAGE_ICONS = [
    ...
    'brewing-lookup'   => '<svg viewBox="0 0 24 24"><rect x="3" y="4" width="13" height="16" rx="2"/><path d="M7 8h6M7 12h5M7 16h3"/><circle cx="18" cy="8" r="3.5"/><path d="M20.5 10.5l2.5 2.5"/></svg>',
