...
- [former-index-archive.md](former-index-archive.md) — verbatim pre-2026-06-05 index narration, CONSOLIDATED (merged 2026-06-19 from the former `former-index-last-updated.md` + `former-index-resume-point.md`): PART 1 = the rolling "Last updated" changelog (former index line 5); PART 2 = the former RESUME POINT detailed narration + landed-arc blocks (former index lines 16-91). Archival; superseded by the thematic topic files + the live §SHIPPED-ARCS pointers in the main index.
