...
- [changelog-2026-06.md](changelog-2026-06.md) — Fermenting state-gated selector + hop-stage model (mig 253).
...
- [former-index-last-updated.md](former-index-last-updated.md) — verbatim block lifted out of the index during the 2026-05-27 lean refactor: the rolling "Last updated" changelog (former index line 5). Archival.
- [former-index-resume-point.md](former-index-resume-point.md) — verbatim block lifted out of the index during the 2026-05-27 lean refactor: the former RESUME POINT detailed narration + landed-arc blocks (former index lines 16-91). Archival.
- ~~index-snapshot-pre-2026-06-05/~~ — **never materialised** (the directory was promised in the 2026-06-05 refactor note but never actually created). The verbatim pre-2026-06-05 index narration lives in `former-index-last-updated.md` + `former-index-resume-point.md` (above) — use those to recover the full inline narration of an arc the lean index now only points to. Dangling pointer corrected during the 2026-06-15 index compaction.
